      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-10 sm:mt-14 grid lg:grid-cols-[3fr_2fr] gap-8 sm:gap-10 items-start">
          ...
          <div ref={stackRef} className="relative aspect-[1600/768] w-full">
            {/* Under every tier: an opaque patch shaped to the gaps the
                original cutout left in the cabin glass. Without it the page's
                white shows through the far-side windows as bright shapes with
                a pale fringe. Generated by scripts/ppf-visualizer-backing.mjs
                and aligned to the same 1600x768 box, so it lines up with all
                five renders and is invisible wherever the car is solid. */}
            <Image
              src="/services/ppf-visualizer-backing.png"
              alt=""
              aria-hidden
              fill
              priority
