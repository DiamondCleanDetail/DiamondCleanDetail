...
export type TintLevel = {
   ...
   * Sedan/Coupe is an M3; Truck/Full-size SUV is a G63. SUV/Minivan is the
   * one bucket still without a set. */
...
export const tintLevels: TintLevel[] = [
  { value: 0, label: "Clear", images: { sedan: "/tint-levels/0.png", truck: "/tint-levels/truck-0.png" } },
  { value: 80, label: "80%", images: {}, windshieldOnly: true },
  { value: 50, label: "50%", images: { sedan: "/tint-levels/50.png", truck: "/tint-levels/truck-50.png" } },
  { value: 35, label: "35%", images: { sedan: "/tint-levels/35.png", truck: "/tint-levels/truck-35.png" } },
  { value: 15, label: "15%", images: { sedan: "/tint-levels/15.png", truck: "/tint-levels/truck-15.png" } },
  { value: 5, label: "5%", images: { sedan: "/tint-levels/5.png", truck: "/tint-levels/truck-5.png" } },
];
