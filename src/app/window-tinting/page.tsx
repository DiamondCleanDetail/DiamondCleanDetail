    ...
    <div className="bg-white text-neutral-900">
      <section className="mx-auto max-w-6xl px-6 pt-10 sm:pt-16 pb-6 sm:pb-10 text-center">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight mt-3">
          See Your Shade <span className="chrome-text-dark">Before You Book.</span>
        </h1>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-neutral-500 max-w-xl mx-auto">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-12 sm:pb-24">
        ...
        <div className="mt-8 bg-neutral-50 border border-neutral-200 rounded-xl p-5 text-sm text-neutral-500">
